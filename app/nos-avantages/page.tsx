...
export default function NosAvantagesPage() {
  return (
    <main className={styles.page}>
      ...
      <section className={styles.ctaSection}><div className={styles.container}><div className={styles.ctaCard}><span className={styles.ctaCoin} aria-hidden="true">€</span><div><p className={styles.kicker}>Prêt à en profiter ?</p><h2>Découvrez les offres qui <em>peuvent vous rapporter plus.</em></h2><p>Comparez les opportunités disponibles, simplement.</p></div><Link href="/offres" className={styles.ctaButton}>Explorer les offres <Icon name="arrow" size={18} /></Link></div></div></section>
