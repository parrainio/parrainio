...
function generateDescription(name: string, category: string): string {
  const descriptions: Record<string, string> = {
    ...
    "SwissBorg": "SwissBorg : application crypto avec un ticket de récompense en Bitcoin pouvant aller jusqu'à 50 € selon le programme.",
    "Crypto.com": "Crypto.com : application crypto avec carte Visa, 25 USD en CRO chacun via le programme BG25, staking requis.",
    ...
    "iGraal": "iGraal : cashback, codes promo et extension de navigateur à activer avant l'achat chez les marchands partenaires.",
    "Poulpeo": "Poulpeo : codes promo et cashback réunis, le parrain gagne 10 % des gains cashback validés de ses filleuls à vie.",
    "eBuyClub": "eBuyClub est un club d'achat en ligne qui propose des réductions et du cashback sur de nombreux marchands.",
    "Widilo": "Widilo : cashback et codes promo dans une cagnotte, bonus du parrain après le premier cashback validé du filleul.",
    "TopCashback": "TopCashback : cashback en ligne, 10 € au filleul et 15 € au parrain après 10 € de cashback approuvé dans les 180 jours.",
    ...
    "OKX": "OKX : plateforme crypto multi-produits, récompenses de parrainage variables selon le territoire, parfois en USDT.",
    ...
    "Sumeria": "Sumeria : banque en ligne avec parrainage intégré à l'application, invitation à accepter sous 7 jours et récompense selon la campagne.",
    ...
    "Wanteeed": "Wanteeed : extension qui teste les codes promo à votre place, avec cashback chez les marchands partenaires.",
    "Naomi": "Naomi : cagnotte de 3 € pour le filleul et 2 € pour le parrain, code à saisir dans les 24 heures.",
    "Lalalab": "Lalalab est une application qui permet d'imprimer ses photos depuis son smartphone.",
    "Shoes.fr": "Shoes.fr : chaussures en ligne, 10 € pour le filleul et le parrain dès 50 € sur la première commande.",
    ...
    "Becquet": "Becquet : maison et décoration, 20 € d'avantage pour le filleul et 20 € de bon pour le parrain sur la première commande.",
    "Biogents": "Biogents : pièges anti-moustiques, 20 % de réduction pour le nouveau client et 10 € en points pour le parrain.",
    ...
    "GMF": "GMF : assurance auto, moto, habitation, santé et prévoyance, jusqu'à 50 € de paniers cadeaux chacun selon la campagne.",
    ...
    "L'Olivier Assurance": "L'Olivier Assurance : devis auto ou habitation, 50 € chacun en Auto et 20 € chacun en Habitation après validation du contrat.",
    ...
    "Weward": "WeWard est une application qui récompense la marche avec des points convertibles en argent.",
    "Macadam": "Macadam : application de cashback, 500 à 1 000 Coins après le code d'invitation et trois jours d'activité.",
    ...
    "Capital Koala": "Capital Koala : le cashback des achats en ligne alimente le livret d'épargne d'un bénéficiaire, 5 € au nouveau membre selon l'invitation après association du livret.",
    ...
    "Pourdebon": "Pourdebon : produits frais et épicerie fine de producteurs français, 3 000 points au parrain après la première commande du filleul.",
    ...
    "Cointiply": "Cointiply : sondages, offres et jeux rémunérés en Coins, avec 25 % des gains du filleul reversés au parrain.",
...
export const offers: Offer[] = [
  ...
  {
    ...createOffer("fortuneo", "Fortuneo", "Banque", "Jusqu'à 160 €", "F"),
  ...
  createOffer("n26", "N26", "Banque", "15 € par parrainage", "N"),
  ...
  createOffer("monabanq", "Monabanq", "Banque", "Jusqu'à 280 €", "M"),
