...
function generateDescription(name: string, category: string): string {
  const descriptions: Record<string, string> = {
    ...
    "Myprotein": "Myprotein est un site de vente de compléments alimentaires et de nutrition sportive.",
    ...
    "Freecash": "Freecash est une plateforme de récompenses qui permet de gagner de l'argent en effectuant diverses tâches.",
    ...
    "Swagbucks": "Swagbucks est une plateforme de récompenses qui permet de gagner de l'argent en effectuant des sondages et des tâches.",
    "Weward": "WeWard est une application qui récompense la marche avec des points convertibles en argent.",
    "Macadam": "Macadam est une application de cashback et de récompenses.",
    "La Première Brique": "La Première Brique est une plateforme d'investissement dans l'immobilier divisé.",
    ...
    "La Belle Vie": "La Belle Vie est un site de vente de produits bio et naturels.",
    ...
    "Greenweez": "Greenweez est un site de vente de produits bio et écologiques.",
