...
export type BlogBlock =
  ...
  /* Accordéon éditorial : questions toujours visibles, réponses repliées.
   * Rendu en <details>/<summary> natifs — le contenu reste présent dans
   * le DOM (et accessible aux crawlers) même lorsque l'accordéon est fermé. */
  | { type: "accordion"; items: BlogAccordionItem[] };

export type BlogAccordionItem = {
  /** Question / titre de section, toujours visible (résumé de l'accordéon). */
  heading: string;
  /** Contenu de la réponse : paragraphes, listes, blocs visuels… */
  blocks: BlogBlock[];
};
...
export const blogArticles: BlogArticle[] = [
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Qu'est-ce que le cashback ?",
            blocks: [
          ...
          {
            heading: "Comment fonctionne le cashback ?",
            blocks: [
          ...
          {
            heading: "Cashback, bonus de parrainage et reversement Parrainio : quelle différence ?",
            blocks: [
          ...
          {
            heading: "Quelles plateformes de cashback sont disponibles sur Parrainio ?",
            blocks: [
          ...
          {
            heading: "Les erreurs à éviter avec le cashback",
            blocks: [
          ...
          {
            heading: "Cashback : est-ce vraiment intéressant ?",
            blocks: [
          ...
          {
            heading: "À savoir avant de s'inscrire",
            blocks: [
              {
                type: "list",
                ordered: false,
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Pourquoi changer de banque ?",
            blocks: [
          ...
          {
            heading: "Qu'est-ce que la mobilité bancaire ?",
            blocks: [
          ...
          {
            heading: "Comment changer de banque étape par étape ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Peut-on profiter d'une prime de parrainage en changeant de banque ?",
            blocks: [
          ...
          {
            heading: "Comment choisir sa nouvelle banque au-delà de la prime ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Quels comptes et produits sont concernés par la mobilité bancaire ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Les erreurs à éviter quand on change de banque",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Prime de parrainage : attention aux conditions",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "À savoir avant de changer de banque",
            blocks: [
            {
        type: "list",
        ordered: false,
    ...
    body: [
...

      {
        ...
        items: [
          ...
          {
            heading: "Comment fonctionne un parrainage chez un fournisseur d'énergie ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Peut-on changer de fournisseur d'électricité ou de gaz facilement ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Que faut-il vérifier avant de changer de fournisseur ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Parrainage énergie : la prime est-elle la seule chose à regarder ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Comment profiter d'une prime de parrainage énergie ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Changement de fournisseur : y a-t-il un risque de coupure ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "À savoir avant de souscrire",
            blocks: [
            {
        type: "list",
        ordered: false,
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Qu'est-ce que le parrainage crypto ?",
            blocks: [
          ...
          {
            heading: "Comment fonctionne un programme de parrainage crypto ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Quelles conditions faut-il généralement remplir ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Quels types de récompenses peut-on recevoir ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Pourquoi le montant d'une récompense peut-il varier ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Parrainage crypto : les étapes pour le filleul",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Ce qu'il faut vérifier avant de s'inscrire",
            blocks: [
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Qu'est-ce qu'un freebet ?",
            blocks: [
          ...
          {
            heading: "Freebet et argent réel : quelle différence ?",
            blocks: [
          ...
          {
            heading: "Comment fonctionne un freebet ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Comment un freebet peut-il être attribué ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Quelles conditions faut-il vérifier ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Que deviennent les gains réalisés avec un freebet ?",
            blocks: [
          ...
          {
            heading: "Pourquoi la valeur affichée d'un freebet peut être trompeuse ?",
            blocks: [
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Comment trouver des filleuls ?",
            blocks: [
          ...
          {
            heading: "Où partager son lien de parrainage ?",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Réseaux sociaux : comment partager sans spammer ?",
            blocks: [
          ...
          {
            heading: "Les plateformes spécialisées de parrainage",
            blocks: [
          ...
          {
            heading: "Comment rédiger un bon message de parrainage ?",
            blocks: [
          ...
          {
            heading: "Faut-il proposer une offre à tout le monde ?",
            blocks: [
          ...
          {
            heading: "Vérifier les conditions avant de partager",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Les erreurs qui peuvent faire perdre une récompense",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Comment utiliser plusieurs programmes intelligemment ?",
            blocks: [
          ...
          {
            heading: "Parrainage : privilégier la qualité plutôt que la quantité",
            blocks: [
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Commencer par savoir où part son argent",
            blocks: [
          ...
          {
            heading: "Distinguer les dépenses fixes, variables et occasionnelles",
            blocks: [
          ...
          {
            heading: "Faire le ménage dans ses abonnements",
            blocks: [
          ...
          {
            heading: "Comparer régulièrement ses contrats et fournisseurs",
            blocks: [
          ...
          {
            heading: "Réduire sa facture d'énergie sans changer ses habitudes",
            blocks: [
          ...
          {
            heading: "Optimiser ses dépenses bancaires",
            blocks: [
          ...
          {
            heading: "Utiliser le cashback sur les achats déjà prévus",
            blocks: [
          ...
          {
            heading: "Vérifier les aides auxquelles on peut avoir droit",
            blocks: [
          ...
          {
            heading: "Les fausses économies à éviter",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Mettre en place une méthode simple et durable",
            blocks: [
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Pourquoi les abonnements pèsent-ils autant dans un budget ?",
            blocks: [
          ...
          {
            heading: "Faire l'inventaire de tous ses abonnements",
            blocks: [
        ...
        items: [
          ...
          {
            heading: "Repérer les abonnements que l'on n'utilise presque jamais",
            blocks: [
        ...
        steps: [
          ...
          {
            heading: "Vérifier les conditions de chaque abonnement",
            blocks: [
          ...
          {
            heading: "Peut-on résilier facilement ?",
            blocks: [
          ...
          {
            heading: "Peut-on payer moins cher sans perdre le service ?",
            blocks: [
          ...
          {
            heading: "Téléphone et internet : comparer avant de changer",
            blocks: [
          ...
          {
            heading: "Services numériques : attention aux essais gratuits",
            blocks: [
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Commencer par savoir ce que l'on paie",
            blocks: [
          ...
          {
            heading: "Votre forfait mobile correspond-il encore à vos besoins ?",
            blocks: [
          ...
          {
            heading: "Vérifier les options et services inclus",
            blocks: [
          ...
          {
            heading: "Regarder le vrai prix de sa box internet",
            blocks: [
          ...
          {
            heading: "Attention aux promotions qui arrivent à leur terme",
            blocks: [
          ...
          {
            heading: "Vérifier son engagement avant de changer",
            blocks: [
          ...
          {
            heading: "Comparer avant de résilier",
            blocks: [
          ...
          {
            heading: "Changer d'opérateur : les points à vérifier",
            blocks: [
  ...
  },
  {
    ...
    body: [
...

      {
        ...
        items: [
          {
            heading: "Le cashback est-il toujours une bonne affaire ?",
            blocks: [
          ...
          {
            heading: "Commencer par l'achat, pas par le cashback",
            blocks: [
          ...
          {
            heading: "Comparer le prix avant de regarder le cashback",
            blocks: [
          ...
          {
            heading: "Vérifier les conditions avant de cliquer",
            blocks: [
          ...
          {
            heading: "Les exclusions à surveiller",
            blocks: [
          ...
          {
            heading: "Peut-on cumuler cashback et code promo ?",
            blocks: [
          ...
          {
            heading: "Pourquoi le cashback n'est pas toujours immédiat",
            blocks: [
          ...
          {
            heading: "Comment éviter les fausses économies",
            blocks: [
          ...
          {
            heading: "Sur quels achats utiliser le cashback ?",
            blocks: [
