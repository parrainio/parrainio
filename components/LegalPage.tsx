      ...
      <footer className={styles.footer}>
        <div className={styles.container}>
          <div className={styles.footerGrid}>
            ...
            <div><h3>Découvrir</h3><Link href="/offres">Les offres</Link><Link href="/classement-primes-parrainage">Classement des primes</Link><Link href="/pourquoi-parrainio">Comment ça marche</Link></div>
            <div><h3>Parrainio</h3><Link href="/pourquoi-parrainio">Nos avantages</Link><a href="mailto:parrainage@parrainio.fr">Contact</a></div>
